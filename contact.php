        ...
        <div class="wrapper">
            ...
            <div class="contact">
                ...
                <form id="myForm" class="contact-form">
                    ...
                    <p class="full">
                        <button type="button" onclick="sendEmail()" data-toggle="modal" data-target="#success_tic" name="submit">Submit</button>
                    </p>
...
<div id="success_tic" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="page-body">
    <div class="head">  
      <h3 style="margin-top:5px;">Your message was sent!</h3>
